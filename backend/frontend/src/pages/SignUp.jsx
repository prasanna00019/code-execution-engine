...
const Signup = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto p-5'>
      <div className='w-[500px] h-[450px] mt-10 p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-blur-lg bg-opacity-0'>
